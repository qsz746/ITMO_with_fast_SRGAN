...
class FastSRGAN(object):
    ...
    def __init__(self, args):
        ...
        Returns:
            None
        """
        self.hr_height = args.hr_image_size
        self.hr_width = args.hr_image_size
        # self.lr_height = self.hr_height // 4  # Low resolution height
        # self.lr_width = self.hr_width // 4  # Low resolution width
        self.lr_height = args.lr_image_size  # Low resolution height
        self.lr_width = args.lr_image_size  # Low resolution width
